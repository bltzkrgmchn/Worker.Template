...
var solution = "Worker.Template.sln";
var releaseNotesPath = "./RELEASE_NOTES.md";
var binaries = "./Sources/Worker.Template.Instance/bin";
var objects = "./Sources/Worker.Template.Instance/obj";
...
Task ("Version")
    .Does (() => {
        ...
        var file = "./Sources/Worker.Template.Instance/AssemlyInfo.cs";
...
Task ("Publish")
    ...
    .Does (() => {
        ...
        DotNetCorePublish("./Sources/Worker.Template.Instance/Worker.Template.Instance.csproj", settings);
